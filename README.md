...
If you have the situation that there is a lot of noise in the air and/or
your device matches multiple protocols, you can limit the available
protocols. This is easily possible with a MQTT message. Just send a JSON
array with your needed protocols to `rfESP_<ChipId>/set/protos`. For
example:

```console
$ mosquitto_pub -t rfESP_fd804/set/protos -m '["elro_800_switch", "arctech_switch"]'
```
